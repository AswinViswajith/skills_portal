...
const AdminDashboard = () => {
  ...
  const fetchAdminDashboard = async () => {
    try {
      const { data } = await axiosInstance.get("/skillSchedule/adminDashboard");
    ...
    <div className="p-6">
      ...
      <Spin spinning={loading}>
        <div className="grid grid-cols-5 gap-4 mb-6">
          <Card title="Total Faculties" bordered>
            <Title level={4}>{metaData.totalFaculties || 0}</Title>
          </Card>
          <Card title="Total Students" bordered>
            <Title level={4}>{metaData.totalStudents || 0}</Title>
          </Card>
          <Card title="Total Departments" bordered>
            <Title level={4}>{metaData.totalDepartments || 0}</Title>
          </Card>
          <Card title="Total Batch " bordered>
            <Title level={4}>{metaData.totalBatches || 0}</Title>
          </Card>
